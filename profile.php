...
?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 intro-pic wow slideInLeft">
                    <img src="src/resources/img/intro-image.jpg" alt="image" class="img-responsive">
                </div>
            ...
            <div class="row row-feat">
                <div class="col-md-4 text-center">
                    ...
                    <div class="feature-img">
                        <img src="src/resources/img/feature-image.jpg" alt="image" class="img-responsive wow fadeInLeft">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 feature-2-pic wow fadeInRight">
                    <img src="src/resources/img/feature2-image.jpg" alt="macbook" class="img-responsive">
                </div>
            </div>
    ...
    <!-- /.download section -->
    <div id="download">
        <div class="action fullscreen parallax" style="background-image:url('src/resources/img/bg.jpg');" data-img-width="2000" data-img-height="1333" data-diff="100">
            <div class="overlay">
                <div class="container">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <img alt="client" src="src/resources/img/company.jpg" class="wow fadeInUp">
                    <img alt="client" src="src/resources/img/company.jpg" class="wow fadeInUp" data-wow-delay="0.2s">
                    <img alt="client" src="src/resources/img/company.jpg" class="wow fadeInUp" data-wow-delay="0.4s">
                    <img alt="client" src="src/resources/img/company.jpg" class="wow fadeInUp" data-wow-delay="0.6s">
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div id="owl-testi" class="owl-carousel owl-theme wow fadeInUp">
                        ...
                        <div class="testi-item">
                            <div class="client-pic text-center">
                                ...
                                <!-- /.client photo -->
                                <img src="src/resources/img/client.jpg" alt="client">
                            </div>
                            <div class="box">
    ...
    <!-- /.contact section -->
    <div id="contact">
        <div class="contact fullscreen parallax" style="background-image:url('src/resources/img/bg.jpg');" data-img-width="2000" data-img-height="1334" data-diff="100">
            <div class="overlay">
                <div class="container">
